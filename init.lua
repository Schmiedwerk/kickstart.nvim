...
-- Remap Ctrl+d and Ctrl+u for more granular skimming
...
require('lazy').setup({
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('gs', '<cmd>LspClangdSwitchSourceHeader<cr>', '[S]witch between source and header')
      ...
      local servers = {
        clangd = { cmd = { 'clangd', '--compile-commands-dir=build-x86_64', '--background-index' } },
        -- gopls = {},
        -- pyright = {},
        -- rust_analyzer = {},
  ...
  { -- Highlight, edit, and navigate code
    ...
    branch = 'master', -- Use the locked 'master' branch instead of the new default branch 'main' (incompatible rewrite)
    build = ':TSUpdate',
